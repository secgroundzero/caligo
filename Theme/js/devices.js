function logout(){
	var connectService="Functions/php/logout.php";
	$.ajax({
		url:connectService,
		type:"POST",
...
function changePassword(){
	...
	var connectService="Functions/php/changePassword.php";
	$.ajax({
		url:connectService,
		type:"POST",
...
function loadDevices(){
	var connectService="Functions/php/c2settingsLoad.php";
	$.ajax({
		url: connectService,
		type: "POST",
		data:{"session":document.cookie}, 
		...
		for (var i=0; i<onlinecount; i++){
			...
			var connectServiceDevice="LoadPort.php";
			setTimeout(function(){ 
			$.ajax({
...
function checkforNewConnection(){
	var connectService ="Functions/php/connectedDevices.php"
...
function deleteDev(id){
	...
	var connectService="Functions/php/c2settingsDelete.php";
        $.ajax({
                url: connectService,
                type: "POST", 
